...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function initGSAP() {
        ...
        // Logo entrance - never set to opacity 0, always visible
        gsap.fromTo(".site-nav .nav-brand", { y: -20 }, { y: 0, duration: 0.8, ease: "power3.out" });
        ...
        if(nav) {
            let isScrolling;
            // Pre-compute isAbsolute so we don't recalculate style on every pixel
