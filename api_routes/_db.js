...
async function seedOrdersIfEmpty() {
  ...
  const now = Date.now();
  const demoOrders = [
    { id:'LB-001', date:new Date(now-86400000*2).toISOString(), status:'delivered', country:'NP', currency:'NPR', symbol:'Rs', items:[{name:'Lwang Black 500g',qty:2,price:2599}], subtotal:5198, shipping:0, total:5198, carrier:'Pathao', customer:{fname:'Aarav',lname:'Shrestha',email:'aarav@email.np',phone:'+977-9800000001'}, payment:{method:'nabil',status:'paid',ref:'NB-DEMO-001'} },
    { id:'LB-002', date:new Date(now-86400000*5).toISOString(), status:'shipped',   country:'AU', currency:'AUD', symbol:'A$', items:[{name:'Lwang Black 250g',qty:1,price:18.99},{name:'French Press',qty:1,price:24.99}], subtotal:43.98, shipping:12.50, total:56.48, carrier:'Australia Post', customer:{fname:'Emma',lname:'Wilson',email:'emma@email.au',phone:'+61400000002'}, payment:{method:'stripe',status:'paid',ref:'pi_demo_au_001'} },
    { id:'LB-003', date:new Date(now-86400000*1).toISOString(), status:'paid',      country:'US', currency:'USD', symbol:'$', items:[{name:'Pot & Press Gift Set',qty:1,price:59.99}], subtotal:59.99, shipping:15.00, total:74.99, carrier:'Australia Post', customer:{fname:'Jake',lname:'Miller',email:'jake@email.us',phone:'+12025550103'}, payment:{method:'stripe',status:'paid',ref:'pi_demo_us_001'} },
    { id:'LB-004', date:new Date(now-86400000*8).toISOString(), status:'delivered', country:'GB', currency:'GBP', symbol:'£', items:[{name:'Lwang Black 500g',qty:1,price:18.99},{name:'Classic T-Shirt',qty:1,price:15.99}], subtotal:34.98, shipping:14.00, total:48.98, carrier:'Australia Post', customer:{fname:'Oliver',lname:'Smith',email:'oliver@email.uk'}, payment:{method:'stripe',status:'paid',ref:'pi_demo_gb_001'} },
    { id:'LB-005', date:new Date(now-86400000*3).toISOString(), status:'pending',   country:'CA', currency:'CAD', symbol:'C$', items:[{name:'Drip Coffee Bags',qty:2,price:16.99}], subtotal:33.98, shipping:18.00, total:51.98, carrier:'Chit Chats', customer:{fname:'Sophie',lname:'Brown',email:'sophie@email.ca'}, payment:{method:'stripe',status:'pending',ref:null} },
    { id:'LB-006', date:new Date(now-86400000*4).toISOString(), status:'paid',      country:'NZ', currency:'NZD', symbol:'NZ$', items:[{name:'Lwang Black 250g',qty:3,price:19.99}], subtotal:59.97, shipping:22.00, total:81.97, carrier:'NZ Post', customer:{fname:'Liam',lname:'Jones',email:'liam@email.nz'}, payment:{method:'stripe',status:'paid',ref:'pi_demo_nz_001'} },
    { id:'LB-2450', date:new Date(now-86400000).toISOString(), status:'paid', country:'AU', currency:'AUD', symbol:'A$', items:[{name:'Lwang Black 250g',qty:2,price:27}], subtotal:54, shipping:14.99, total:68.99, carrier:'Australia Post', tracking:'', customer:{fname:'Emma',lname:'Wilson',email:'emma@email.au',phone:'+61412345678',address:'12 George St Sydney NSW 2000'}, payment:{method:'paypal',status:'paid',ref:'PP-5X9284K'} },
    { id:'LB-2449', date:new Date(now-172800000).toISOString(), status:'shipped', country:'AU', currency:'AUD', symbol:'A$', items:[{name:'Lwang Black 500g',qty:1,price:37},{name:'French Press',qty:1,price:34.99}], subtotal:71.99, shipping:14.99, total:86.98, carrier:'Australia Post', tracking:'AUP123456', customer:{fname:'Liam',lname:'Chen',email:'liam@email.au',phone:'+61487654321',address:'45 Collins St Melbourne VIC 3000'}, payment:{method:'afterpay',status:'paid',ref:'AP-8876543'} },
    { id:'LB-2448', date:new Date(now-259200000).toISOString(), status:'delivered', country:'NP', currency:'NPR', symbol:'Rs', items:[{name:'Lwang Black 500g',qty:2,price:2599}], subtotal:5198, shipping:0, total:5198, carrier:'Pathao', tracking:'', customer:{fname:'Aarav',lname:'Shrestha',email:'aarav@email.np',phone:'+977984123456',address:'Durbarmarg, Kathmandu'}, payment:{method:'nabil',status:'paid',ref:'NB-2448'} },
  ];
