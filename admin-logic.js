...
function getDemoOrders(){
  return[
    {id:'LB-2450',date:new Date(Date.now()-86400000).toISOString(),status:'paid',country:'AU',currency:'AUD',symbol:'A$',items:[{name:'Lwang Black 250g',qty:2,price:27,image:'https://cdn2.blanxer.com/uploads/68b26f1169953999df49c53a/product_image-dsc07401-8095.webp'}],subtotal:54,shipping:14.99,total:68.99,carrier:'DHL',tracking:'',customer:{fname:'Emma',lname:'Wilson',email:'emma@email.au',phone:'+61412345678',address:'12 George St Sydney NSW 2000'},payment:{method:'paypal',status:'paid',ref:'PP-5X9284K'}},
    {id:'LB-2449',date:new Date(Date.now()-172800000).toISOString(),status:'shipped',country:'AU',currency:'AUD',symbol:'A$',items:[{name:'Lwang Black 500g',qty:1,price:37},{name:'French Press',qty:1,price:34.99}],subtotal:71.99,shipping:14.99,total:86.98,carrier:'DHL',tracking:'DHL123456',customer:{fname:'Liam',lname:'Chen',email:'liam@email.au',phone:'+61487654321',address:'45 Collins St Melbourne VIC 3000'},payment:{method:'afterpay',status:'paid',ref:'AP-8876543'}},
    ...
    {id:'LB-2443',date:new Date(Date.now()-691200000).toISOString(),status:'cancelled',country:'JP',currency:'JPY',symbol:'¥',items:[{name:'Lwang Black 250g',qty:1,price:2299}],subtotal:2299,shipping:0,total:2299,carrier:'DHL',tracking:'',customer:{fname:'Yuki',lname:'Tanaka',email:'yuki@email.jp',phone:'+81312345678',address:'2-1-1 Nihonbashi Tokyo'},payment:{method:'paypal',status:'failed',ref:null}},
    {id:'LB-2442',date:new Date(Date.now()-777600000).toISOString(),status:'delivered',country:'NP',currency:'NPR',symbol:'Rs',items:[{name:'Lwang Black 250g',qty:1,price:1599}],subtotal:1599,shipping:0,total:1599,carrier:'Local',tracking:'COD-KTM001',customer:{fname:'Sita',lname:'Gurung',email:'sita@email.np',phone:'+977985000001',address:'Thamel, Kathmandu'},payment:{method:'cod',status:'paid',ref:'COD-2442'}},
  ];
}
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div class="form-row">
          ...
          <select class="form-input" id="providerSelect_${o.id}">
            <option value="dhl" ${o.shipping_provider === 'dhl' ? 'selected' : ''}>DHL</option>
            <option value="japan_post" ${o.shipping_provider === 'japan_post' ? 'selected' : ''}>Japan Post</option>
            <option value="local_delivery" ${o.shipping_provider === 'local_delivery' ? 'selected' : ''}>Local Delivery</option>
          </select>
        </div>
        <div class="form-row">
