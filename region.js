...
function updateHomeProducts(code) {
  ...
  const showcaseIds = ['lb-pot-and-press-gift-set', 'lwang-black-drip-set', '5oog-lwang-black-mix', '250g-lwang-black', 'lwang-black-drip-coffee-bags'];
  let html = '';
  ...
  showcaseIds.forEach(id => {
    ...
    html += `
      <div class="product-card" onclick="window.location='catalogue.html#product-${id}'" style="cursor:pointer;">
        ...
        <p style="margin-bottom:2rem; flex-grow:1; color:var(--text-muted); font-size:0.9rem; line-height:1.7; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;">${pDesc}</p>
